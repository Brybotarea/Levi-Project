...
module.exports.run = async function({ api, event, args }) {
  ...
  if (!input) {
    return api.sendMessage(`Please provide a question or statement after 'ai'. For example: 'ai What is the capital of France?'(➡️Levi Bry Project)`, event.threadID, event.messageID);
  }
